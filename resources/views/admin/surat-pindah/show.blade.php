...
@section('title', 'Detail Surat Pindah')
...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-2">
            <span class="text-muted">Detail Pengajuan Surat Pindah</span>
        </h4>
                                    ...
                                    @foreach ($surat->dokumenPendukung as $dokumen)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('admin.surat-pindah.download-pendukung', $dokumen->id) }}"
                ...
                @if ($surat->file_surat_path)
                    <div class="mb-4">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('admin.surat-pindah.download', $surat->id) }}" class="btn btn-success">
        ...
        @if (auth()->user()->hasRole('staff') && in_array($surat->status, ['diajukan', 'disetujui']))
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.surat-pindah.update-status', $surat->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <x-template-notes-selector textarea-id="catatan_admin" textarea-name="catatan_admin"
                                    :current-value="old('catatan_admin', $surat->status()->first()?->catatan_admin)" user-role="staff" status-field="status" />
        ...
        @if (auth()->user()->hasRole('dosen'))
            ...
            @if (($surat->status === 'diproses' && $isKaprodi) || ($surat->status === 'disetujui_kaprodi' && $isPimpinan))
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.surat-pindah.approve', $surat->id) }}" method="POST"
                            id="approvalForm">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="mb-3">
                                ...
                                <x-template-notes-selector textarea-id="catatan_admin_dosen" textarea-name="catatan_admin"
                                    :current-value="old('catatan_admin', $surat->status()->first()?->catatan_admin)" user-role="dosen" />
                            </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (btnApprove && btnReject) {
                ...
                btnApprove.addEventListener('click', function() {
                    ...
                    const approveTemplates = document.getElementById(
                    'template-approve-catatan_admin_dosen');
