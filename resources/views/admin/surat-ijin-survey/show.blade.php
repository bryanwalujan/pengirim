{{-- filepath: resources/views/admin/surat-ijin-survey/show.blade.php --}}
                ...
                <div class="mb-4">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" value="{{ $surat->judul }}" readonly>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Tempat Survey</label>
                            <input type="text" class="form-control" value="{{ $surat->tempat_survey }}" readonly>
                        </div>
