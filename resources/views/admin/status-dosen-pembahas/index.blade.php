...
@section('title', 'Status Dosen Pembahas')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-custom-icon">
                ...
                <li class="breadcrumb-item active" aria-current="page">Status Dosen Pembahas</li>
            </ol>
        </nav>

        <h4 class="fw-bold py-3 mb-2" style="margin-top: -1.2rem">
            <span class="text-muted fw-light">Manajemen /</span> Status Dosen Pembahas
        </h4>
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                <div class="card h-100">
                    <div class="card-body text-center">
                        ...
                        <h3 class="card-title mb-0">{{ count($pembahasStatistics) }}</h3>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 mb-4">
                <div class="card h-100">
                    <div class="card-body text-center">
                        ...
                        <h3 class="card-title mb-0">{{ collect($pembahasStatistics)->sum('beban_active') }}</h3>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 mb-4">
                <div class="card h-100">
                    <div class="card-body text-center">
                        ...
                        <h3 class="card-title mb-0">{{ collect($pembahasStatistics)->sum('beban_replaced') }}</h3>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 mb-4">
                <div class="card h-100">
                    <div class="card-body text-center">
                        ...
                        <h3 class="card-title mb-0">
                            {{ count($pembahasStatistics) > 0 ? number_format(collect($pembahasStatistics)->avg('total_beban'), 1) : 0 }}
                        </h3>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-header border-bottom py-3">
                            <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                                <h5 class="m-0 text-primary fw-bold">
                                    <i class="bx bx-user-check me-2"></i>Status Beban Dosen Pembahas
                                </h5>
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <a href="{{ route('admin.pendaftaran-seminar-proposal.export-status-dosen') }}" class="btn btn-outline-success btn-sm">
                    ...
                    <div class="card">
                        <div class="card-header border-bottom py-3">
                            <h5 class="m-0 text-danger fw-bold">
                                <i class="bx bx-history me-2"></i>Detail Dosen Digantikan (Seminar Proposal)
                            </h5>
                        </div>
                        <div class="card-body pt-4">
                            @php
                                $replacedHistory = collect($pembahasStatistics)->flatMap(function($stat) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex flex-column">
                                                        ...
                                                        <small class="text-muted">Seminar Proposal</small>
                                                    </div>
                                                </td>
                                                <td class="text-center">
                                                    <div class="d-flex flex-column">
                                                        <span>{{ \Carbon\Carbon::parse($history->tanggal)->translatedFormat('d F Y') }}</span>
                                                        <small class="text-muted">{{ \Carbon\Carbon::parse($history->jam_mulai)->format('H:i') }} WIB</small>
                                                    </div>
                                                </td>
                                                <td class="text-center">
