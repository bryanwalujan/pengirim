        ...
        <div class="modal-content">
            <div class="modal-header bg-label-warning">
                <h5 class="modal-title" id="modalDosenStatusLabel">
                    <i class="bx bx-list-ul me-2"></i>Status Beban Dosen Penguji
                </h5>
            ...
            <div class="modal-body">
                ...
                <div class="alert alert-warning d-flex align-items-start mb-3">
                    ...
                    <div>
                        <strong>Informasi:</strong> Tabel ini menampilkan beban kerja semua dosen sebagai penguji ujian hasil. 
                        Gunakan informasi ini untuk membantu menentukan penguji yang seimbang.
                    </div>
                </div>
                ...
                <ul class="nav nav-pills mb-3" id="dosenStatusTabs" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="all-tab" data-bs-toggle="pill"
                            ...
                            <span class="badge bg-label-dark ms-1">{{ count($pengujiStatistics) }}</span>
                        </button>
                    </li>
                    <li class="nav-item" role="presentation">
            ...
            <div class="modal-footer">
                <a href="{{ route('admin.pendaftaran-ujian-hasil.export-status-dosen') }}" 
