...
@section('title', 'Verifikasi Surat Usulan Ujian Hasil (Skripsi)')
        ...
        <div class="verification-card">
            ...
            <div class="verification-header {{ $document['status_code'] === 'selesai' ? '' : 'pending' }}">
                ...
                <span class="document-type">
                    ...
                    Surat Usulan Ujian Hasil (Skripsi)
                </span>
            </div>
            ...
            <div class="verification-content">
                    ...
                    <div class="info-card-body">
                        <div class="info-row">
                            ...
                            <div class="info-value judul-skripsi">
                                {{ $document['skripsi']['judul'] }}
                            </div>
                        </div>
                        <div class="info-row">
                            <div class="info-label">IPK</div>
                            <div class="info-value">
                                <strong>{{ $document['skripsi']['ipk'] }}</strong>
                            </div>
                        </div>
                        <div class="info-row">
                            <div class="info-label">Dosen Pembimbing 1</div>
                            <div class="info-value">
                                <strong>{{ $document['skripsi']['dosen_pembimbing1'] }}</strong>
                                @if (isset($document['skripsi']['dosen_pembimbing1_nip']) && $document['skripsi']['dosen_pembimbing1_nip'] !== '-')
                                    <span class="text-muted-custom">NIP:
                                        {{ $document['skripsi']['dosen_pembimbing1_nip'] }}</span>
                                @endif
                            </div>
                        </div>
                        <div class="info-row">
                            ...
                            <div class="info-value">
                                <strong>{{ $document['skripsi']['dosen_pembimbing2'] }}</strong>
                                @if (isset($document['skripsi']['dosen_pembimbing2_nip']) && $document['skripsi']['dosen_pembimbing2_nip'] !== '-')
                                    <span class="text-muted-custom">NIP:
                                        {{ $document['skripsi']['dosen_pembimbing2_nip'] }}</span>
                                @endif
                            </div>
                        </div>
                    </div>
                ...
                <!-- Penguji Information -->
                @if (isset($document['penguji']) && count($document['penguji']) > 0)
                    <div class="info-card">
                        <div class="info-card-header">
                                ...
                                <div class="info-row">
                                    ...
                                    <div class="info-value">
                                        ...
                                        @if (isset($penguji['keterangan']) && $penguji['keterangan'])
                                            <span class="badge-keterangan">{{ $penguji['keterangan'] }}</span>
                                        @endif
                                        @if (isset($penguji['nip']) && $penguji['nip'] !== '-')
                                            <span class="text-muted-custom">NIP: {{ $penguji['nip'] }}</span>
                                        @endif
                                    </div>
                                </div>
                            @endforeach
