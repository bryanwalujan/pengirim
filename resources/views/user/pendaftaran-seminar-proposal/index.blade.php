<!-- filepath: resources/views/user/pendaftaran-seminar-proposal/index.blade.php -->
...
@section('main')
    ...
    <div class="page-title light-background">
        <div class="container">
            <h1 data-aos="fade-up" class="text-2xl md:text-3xl">Riwayat Pendaftaran Seminar Proposal</h1>
            <nav class="breadcrumbs" data-aos="fade-up" data-aos-delay="100">
                <ol>
                    ...
                    <li class="current">Seminar Proposal</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <section class="py-8 bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50">
        <div class="container mx-auto px-4 max-w-6xl">
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-gray-700 mb-3 text-sm leading-relaxed">
                                        Anda belum memiliki pendaftaran seminar proposal. Silakan klik tombol
                                        <span class="font-bold text-orange-600">"Buat Pendaftaran Baru"</span>
                                    ...
                                    <div class="bg-amber-50 border border-amber-200 rounded-lg p-3 mt-3">
                                        <div class="flex items-start gap-2">
                                            ...
                                            <p class="text-xs text-amber-800 font-medium leading-relaxed">
                                                <span class="font-bold">Catatan:</span> Pastikan Komisi Proposal Anda sudah
                                                disetujui sebelum melakukan pendaftaran seminar proposal.
                                            </p>
                                        </div>
                                    </div>
                                </div>
            ...
            {{-- ✅ TAMBAHAN: Call-to-Action untuk Jadwal Seminar Proposal --}}
            @php
                $latestSelesai = $pendaftaran->where('status', 'selesai')->first();
            @endphp
            @if($latestSelesai)
                <div class="mb-6 animate-fade-in" data-aos="fade-up" x-data="{ show: true }" x-show="show">
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-gray-700 text-sm mb-4 leading-relaxed">
                                    Pendaftaran seminar proposal Anda telah selesai diproses! Sekarang Anda dapat melihat 
                                    <strong class="text-blue-700">Jadwal Seminar Proposal</strong> yang telah ditentukan.
                                </p>
                            ...
                            @forelse ($pendaftaran as $item)
                                <tr class="hover:bg-orange-50 transition-colors duration-200">
                                    ...
                                    <td class="px-5 py-4 whitespace-nowrap text-center">
                                        <a href="{{ route('user.pendaftaran-seminar-proposal.show', $item->id) }}"
