{{-- filepath: resources/views/user/pendaftaran-ujian-hasil/show.blade.php --}}
...
@section('main')
    ...
    <div class="page-title light-background">
        <div class="container">
            <h1 data-aos="fade-up" class="text-2xl md:text-3xl">Detail Pendaftaran Ujian Hasil</h1>
            <nav class="breadcrumbs" data-aos="fade-up" data-aos-delay="100">
                <ol>
                    ...
                    <li><a href="{{ route('user.pendaftaran-ujian-hasil.index') }}">Ujian Hasil</a></li>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                        ...
                        <div class="p-6 space-y-5">
                            ...
                            <div class="space-y-3">
                                ...
                                <div
                                    class="flex items-center justify-between p-3 bg-gradient-to-r from-orange-50 to-amber-50 rounded-xl">
                                    <div class="flex items-center gap-2">
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                        ...
                        <div class="p-6">
                            <div class="space-y-0">
                                @php
                                    $statuses = [
                                        'pending' => 'Menunggu Penentuan Penguji',
                                        'penguji_ditentukan' => 'Penguji Ditentukan',
                                        'surat_diproses' => 'Surat Diproses',
                                        'menunggu_ttd_kaprodi' => 'Menunggu TTD Kaprodi',
                                        'menunggu_ttd_kajur' => 'Menunggu TTD Kajur',
                                        'selesai' => 'Selesai',
                                    ];
                                ...
                                @foreach ($statuses as $key => $label)
                                    ...
                                    <div class="relative pl-8 pb-8 last:pb-0">
                                        ...
                                        {{-- Content --}}
                                        <div>
                                            <p class="text-sm font-medium {{ $textClass }}">{{ $label }}</p>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
