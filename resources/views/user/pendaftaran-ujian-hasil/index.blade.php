...
@section('main')
    ...
    <section class="py-8 bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50">
        <div class="container mx-auto px-4 max-w-6xl">
            ...
            {{-- ✅ TAMBAHAN: Call-to-Action untuk Jadwal Ujian Hasil --}}
            @php
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-gray-700 text-sm mb-4 leading-relaxed">
                                    Pendaftaran ujian hasil Anda telah selesai diproses! Sekarang Anda dapat melihat 
                                    <strong class="text-blue-700">Jadwal Ujian Hasil</strong> yang telah ditentukan.
                                </p>
