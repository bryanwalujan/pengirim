                ...
                <div class="mb-5 animate-slide-down" x-data="{ show: true }" x-show="show" x-init="setTimeout(() => show = false, 5000)">
                    <div class="bg-amber-50 border-l-4 border-amber-500 rounded-lg p-4 shadow-md">
                        <div class="flex items-center">
                            ...
                            <button @click="show = false"
                                class="ml-3 flex-shrink-0 text-amber-500 hover:text-amber-700 transition-colors">
                                <svg class="h-4 w-4" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd"
                                        d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
                                        clip-rule="evenodd" />
                            ...
                            <div class="flex flex-col md:flex-row gap-6">
                                ...
                                <div class="flex-grow space-y-4">
                                    ...
                                    @if ($latestHasil->status === 'approved')
                                        <div class="bg-emerald-50 border border-emerald-200 rounded-xl p-4 space-y-3">
                                            <div class="flex items-start gap-3 text-sm">
                                                ...
                                                <div>
                                                    ...
                                                    <span class="text-emerald-700 ml-1 font-medium">
                                                        {{ $latestHasil->tanggal_persetujuan_korprodi ? $latestHasil->tanggal_persetujuan_korprodi->translatedFormat('d F Y, H:i') : '-' }}
                                                        WITA
                                                    </span>
                                                </div>
                                            </div>
                                            <div class="flex items-start gap-3 text-sm">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="text-emerald-700 mt-1 font-medium leading-relaxed">
                                        ...
                                        {{-- ✅ TAMBAHAN: Call-to-Action untuk Pendaftaran Ujian Hasil --}}
                                            ...
                                            <div class="flex items-start gap-4">
                                                ...
                                                <div class="flex-1">
                                                    ...
                                                    <p class="text-gray-700 text-sm mb-4 leading-relaxed">
                                                        Komisi hasil Anda telah disetujui! Sekarang Anda dapat melanjutkan ke tahap berikutnya dengan 
                                                        <strong class="text-blue-700">mendaftar Ujian Hasil</strong>.
                                                    </p>
                                                ...
                                                <div class="flex-1">
                                                    ...
                                                    <div class="space-y-2">
                                                        <div
                                                            ...
                                                            @else
                                                                <span
                                                                    class="px-2 py-1 bg-emerald-100 text-emerald-800 text-[10px] font-bold rounded-full">✓
                                                                    Disetujui</span>
                                                            @endif
                                                        </div>
                                                        <div
                                                            class="flex items-center justify-between bg-white rounded-lg p-2.5 shadow-sm">
                                                            <span class="text-orange-700 font-medium">• P2:
                                                                {{ $latestHasil->pembimbing2->name ?? '-' }}</span>
                                    ...
                                    <div class="bg-amber-50 border border-amber-200 rounded-lg p-3 mt-3">
                                        <div class="flex items-start gap-2">
                                            ...
                                            <p class="text-xs text-amber-800 font-medium leading-relaxed">
                                                <span class="font-bold">Catatan:</span> Anda hanya dapat mengajukan komisi
                                                hasil
                                                <span class="font-bold">sekali</span>. Pastikan semua data yang Anda isi
                                ...
                                <tr class="hover:bg-orange-50 transition-colors duration-200">
                                        ...
                                        <div class="space-y-2">
                                            ...
                                            <div class="space-y-1 text-xs text-gray-600">
                                                <div class="flex items-center gap-1.5">
                                                    ...
                                                    <span
                                                        class="font-medium">{{ $hasil->pembimbing1->name ?? 'N/A' }}</span>
                                                    @if ($hasil->status !== 'pending')
                                                        <span
                                                            class="inline-flex items-center px-1.5 py-0.5 rounded-full text-[10px] font-bold bg-emerald-100 text-emerald-800">
                                                            ✓
                                                        </span>
                                                    @endif
                                                </div>
                                                <div class="flex items-center gap-1.5">
                                                    <svg class="w-4 h-4 text-orange-600" fill="currentColor"
                                                        viewBox="0 0 20 20">
                                                        <path fill-rule="evenodd"
                                                            d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z"
                                                            clip-rule="evenodd" />
                                                    ...
                                                    <span
                                                        class="font-medium">{{ $hasil->pembimbing2->name ?? 'N/A' }}</span>
                                    ...
                                    <td class="px-5 py-4 whitespace-nowrap">
                                        <div class="space-y-1">
                                            @if ($hasil->status == 'pending')
                                                <span
                                                    class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold bg-amber-100 text-amber-800 border-amber-300">
                                        ...
                                        <div class="flex items-center justify-center gap-2">
                                            @if ($hasil->status == 'approved' && $hasil->file_komisi_hasil)
                                                <a href="{{ route('user.komisi-hasil.download', $hasil->id) }}"
                                                    ...
                                                    data-bs-toggle="tooltip" title="Download Dokumen Final">
                                            ...
                                            @else
                                                <button
                                                    ...
                                                    disabled data-bs-toggle="tooltip" title="Sedang Diproses">
                                                    <svg class="w-4 h-4 animate-spin" fill="currentColor"
                                                        viewBox="0 0 20 20">
                                                        <path fill-rule="evenodd"
                                                            d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z"
                                                            clip-rule="evenodd" />
                                        ...
                                        <div class="text-center space-y-4">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-gray-600 text-sm max-w-sm mx-auto mb-6 leading-relaxed">
                                                    Anda belum pernah membuat pengajuan komisi hasil. Mulai pengajuan
