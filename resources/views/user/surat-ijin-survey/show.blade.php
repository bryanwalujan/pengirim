...
@section('main')
    <div class="page-title light-background">
        <div class="container">
            <h1 data-aos="fade-up">Detail Surat Ijin Survey</h1>
            <nav class="breadcrumbs" data-aos="fade-up" data-aos-delay="100">
                <ol>
                    <li><a href="{{ route('user.home.index') }}">Beranda</a></li>
                    <li><a href="{{ route('user.surat-ijin-survey.index') }}">Surat Ijin Survey</a></li>
                    ...
                    @if ($surat->status === 'siap_diambil')
                        <div class="status-alert alert-success d-flex align-items-center" data-aos="fade-up">
                            ...
                            <div class="status-content">
                                ...
                                <p class="mb-0">Selamat! Surat ijin survey Anda telah selesai diproses dan siap untuk
                                    diambil. Silakan konfirmasi pengambilan untuk dapat mengunduh surat.</p>
                                <div class="action-buttons-enhanced">
                                    <form action="{{ route('user.surat-ijin-survey.confirm-taken', $surat->id) }}"
                    ...
                    @elseif($surat->status === 'ditolak')
                        <div class="status-alert alert-danger d-flex align-items-center" data-aos="fade-up">
                            ...
                            <div class="status-content">
                                ...
                                <p class="mb-0">Maaf, pengajuan surat ijin survey Anda ditolak. Silakan periksa alasan
                                ...
                                @endif
                                <div class="action-buttons-enhanced">
                                    <a href="{{ route('user.surat-ijin-survey.create') }}"
                    ...
                    <div class="card" data-aos="fade-up">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-5" data-aos="fade-up" data-aos-delay="200">
                                ...
                                <div class="row g-4">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" value="{{ $surat->judul ?? '-' }}"
                                            readonly>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label">Tempat Survey</label>
                                        <input type="text" class="form-control"
                                            value="{{ $surat->tempat_survey ?? '-' }}" readonly>
                                    </div>
                                    <div class="col-12">
                            ...
                            <div class="d-flex justify-content-between mt-5" data-aos="fade-up" data-aos-delay="500">
                                <a href="{{ route('user.surat-ijin-survey.index') }}" class="btn btn-secondary">
