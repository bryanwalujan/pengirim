                    ...
                    <div class="card" data-aos="fade-up">
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center w-100">
                                ...
                                <a href="{{ route('user.surat-ijin-survey.create') }}" class="btn btn-primary">
                        ...
                        <div class="card-body">
                            <div class="filter-section">
                                <form id="filter-form" method="GET" action="{{ route('user.surat-ijin-survey.index') }}">
                                    <div class="row g-3">
                                        <div class="col-md-4">
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="6" class="empty-state">
                                                    ...
                                                    <p>Anda belum pernah mengajukan surat ijin survey. Yuk, ajukan sekarang!
                                                    </p>
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#filter-status, #filter-semester').change(function() {
                $('#filter-form').submit();
            });
            ...
            $('#reset-filter').click(function() {
                $('#filter-status, #filter-semester').val('').trigger('change');
                $('#search-input').val('');
                $('#filter-form').submit();
            });
