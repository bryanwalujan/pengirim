...
@section('main')
    <div class="page-title light-background">
        <div class="container">
            <h1 data-aos="fade-up">Daftar Surat Ijin Survey</h1>
            <nav class="breadcrumbs" data-aos="fade-up" data-aos-delay="100">
                <ol>
                    ...
                    <li class="current">Surat Ijin Survey</li>
                </ol>
            </nav>
        </div>
    </div>
                    ...
                    <div class="surat-card" data-aos="fade-up">
                        <div class="surat-card-header">
                            <div class="d-flex justify-content-between align-items-center w-100">
                                <h4 class="surat-card-title">
                                    ...
                                    Riwayat Pengajuan Surat Ijin Survey
                                </h4>
                                <a href="{{ route('user.surat-ijin-survey.create') }}" class="btn-surat-primary">
                        ...
                        <div class="surat-card-body">
                            ...
                            <div class="surat-filter-section">
                                <form method="GET" action="{{ route('user.surat-ijin-survey.index') }}">
                                    <div class="row g-3 align-items-end">
                                        <div class="col-md-6">
                                            <div class="surat-search-box">
                                                <input type="text" class="form-control" name="search"
                                                    placeholder="Cari berdasarkan judul survey, tempat, atau keterangan..."
                                        ...
                                        <div class="col-md-3">
                                            <a href="{{ route('user.surat-ijin-survey.index') }}"
                            ...
                            <div class="surat-table-container">
                                        ...
                                        <table class="surat-table table">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th width="20%">Judul Survey</th>
                                                    <th width="20%">Tempat Survey</th>
                                            ...
                                            <tbody>
                                                @foreach ($surats as $surat)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="fw-semibold" title="{{ $surat->judul }}">
                                                                {{ Str::limit($surat->judul, 35) }}
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div title="{{ $surat->tempat_survey }}">
                                                                {{ Str::limit($surat->tempat_survey, 30) }}
                                                            </div>
                                                        ...
                                                        <td>
                                                            <div class="surat-action-buttons">
                                                                <a href="{{ route('user.surat-ijin-survey.show', $surat->id) }}"
                                                                ...
                                                                @if ($surat->file_surat_path && in_array($surat->status, ['sudah_diambil', 'disetujui']))
                                                                    <a href="{{ route('user.surat-ijin-survey.download', $surat->id) }}"
                                ...
                                @else
                                    <div class="surat-empty-state">
                                        ...
                                        <p>Anda belum pernah mengajukan surat ijin survey. Jika Anda memerlukan surat ijin
                                            untuk melakukan survey atau penelitian, silakan ajukan sekarang.</p>
                                        <a href="{{ route('user.surat-ijin-survey.create') }}" class="btn-surat-primary">
                                            <i class="bi bi-plus-circle"></i>
                                            Ajukan Sekarang
                                        </a>
