{{-- filepath: resources/views/user/jadwal-ujian-hasil/index.blade.php --}}
...
@section('main')
    <div class="page-title light-background">
        <div class="container">
            <h1 data-aos="fade-up">Jadwal Ujian Hasil</h1>
            <nav class="breadcrumbs" data-aos="fade-up" data-aos-delay="100">
                <ol>
                    ...
                    <li class="current">Jadwal Ujian Hasil</li>
                </ol>
            </nav>
        </div>
    </div>
                        ...
                        <div class="p-6">
                            <div class="space-y-4">
                                ...
                                <div class="flex items-start justify-between pb-4 border-b border-gray-100">
                                    ...
                                    <span class="font-medium text-gray-800">{{ $pendaftaran->dosenPembimbing1->name ?? '-' }}</span>
                                </div>
                                <div class="flex items-start justify-between">
                                    ...
                                    <span class="font-medium text-gray-800">{{ $pendaftaran->dosenPembimbing2->name ?? '-' }}</span>
                                </div>
                            </div>
                        ...
                        <div class="p-6">
                            @if ($jadwal && $jadwal->hasSkFile())
                                ...
                                <div class="grid grid-cols-2 gap-3 mb-3">
                                    <a href="{{ route('user.jadwal-ujian-hasil.view-sk', $jadwal) }}" target="_blank"
                                    ...
                                    <a href="{{ route('user.jadwal-ujian-hasil.download-sk', $jadwal) }}"
                                ...
                                @php
                                    // Allow delete if status is 'menunggu_jadwal' OR 'dijadwalkan' without berita acara
                                    $canDelete = $jadwal->status === 'menunggu_jadwal' || 
                                                 ($jadwal->status === 'dijadwalkan' && !$jadwal->hasBeritaAcara());
                                @endphp

                                @if ($canDelete)
                                    <form action="{{ route('user.jadwal-ujian-hasil.delete-sk', $jadwal) }}"
                                        method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
                            ...
                            @else
                                {{-- Form upload SK --}}
                                <form action="{{ route('user.jadwal-ujian-hasil.upload-sk') }}" method="POST"
                                    ...
                                    <div class="mb-6">
                                        <label class="block text-sm font-bold text-gray-700 mb-3">
                                            File SK Ujian Hasil (PDF, Maks 2MB) <span class="text-red-500">*</span>
                                        </label>
                                        <div class="relative">
                                    ...
                                    <div class="flex items-start">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm text-blue-700 leading-relaxed">
                                                Setelah SK Ujian Hasil diupload, admin akan melakukan penjadwalan ujian
                                                hasil Anda.
                                            </p>
                                        </div>
                                    </div>
                ...
                uploadForm.addEventListener('submit', function(e) {
                    ...
                    if (!file) {
                        Swal.fire({
                            ...
                            text: 'Silakan pilih file SK Ujian Hasil terlebih dahulu',
                            confirmButtonColor: '#f59e0b',
                            confirmButtonText: 'OK'
                        });
                        return false;
                    ...
                    Swal.fire({
                        ...
                        html: `
                            <div class="text-start">
                                <p class="mb-3">Apakah Anda yakin ingin mengupload file SK Ujian Hasil?</p>
                                ...
                                <div class="alert alert-warning mb-0">
                                    <small>
                                        ...
                                        <strong>Perhatian:</strong> Pastikan file yang diupload adalah SK Ujian Hasil yang benar
                                    </small>
                                </div>
                            </div>
                        `,
                        ...
                        if (result.isConfirmed) {
                            ...
                            // Show loading
                            Swal.fire({
                                title: 'Uploading SK Ujian Hasil',
                                html: `
            ...
            if (deleteForm) {
                deleteForm.addEventListener('submit', function(e) {
                    ...
                    Swal.fire({
                        ...
                        html: `
                            <div class="text-start">
                                <p class="mb-3">Apakah Anda yakin ingin menghapus SK Ujian Hasil?</p>
                                <div class="alert alert-danger mb-0">
                                    <small>
                                        <i class="bx bx-error-circle me-1"></i>
                                        <strong>Perhatian:</strong> Setelah dihapus, Anda harus mengupload ulang file SK Ujian Hasil yang baru.
                                    </small>
                                </div>
                            </div>
                        `,
                        ...
                        if (result.isConfirmed) {
                            ...
                            Swal.fire({
                                title: 'Menghapus SK Ujian Hasil',
