                    ...
                    @if ($surat->status === 'siap_diambil')
                        <div class="status-alert alert-success d-flex align-items-center" data-aos="fade-up">
                            ...
                            <div class="status-content">
                                ...
                                <p class="mb-0">Selamat! Surat pindah Anda telah selesai diproses dan siap untuk
                                    diambil. Silakan konfirmasi pengambilan untuk dapat mengunduh surat.</p>
                                <div class="action-buttons-enhanced">
                                    <form action="{{ route('user.surat-pindah.confirm-taken', $surat->id) }}" method="POST"
                                        class="d-inline">
                                        @csrf
                    ...
                    @elseif($surat->status === 'ditolak')
                        <div class="status-alert alert-danger d-flex align-items-center" data-aos="fade-up">
                            ...
                            <div class="status-content">
                                ...
                                <p class="mb-0">Maaf, pengajuan surat pindah Anda ditolak. Silakan periksa alasan
                                ...
                                @endif
                                <div class="action-buttons-enhanced">
                                    <a href="{{ route('user.surat-pindah.create') }}" class="btn btn-enhanced btn-primary">
