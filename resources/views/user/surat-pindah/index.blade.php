                    ...
                    <div class="card" data-aos="fade-up">
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center w-100">
                                ...
                                <a href="{{ route('user.surat-pindah.create') }}" class="btn btn-primary">
                        ...
                        <div class="card-body">
                            <div class="filter-section">
                                <form id="filter-form" method="GET" action="{{ route('user.surat-pindah.index') }}">
                                    <div class="row g-3">
                                        <div class="col-md-4">
                                ...
                                <table class="table table-hover" id="surat-table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="20%">Universitas Tujuan</th>
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="6" class="empty-state">
                                                    ...
                                                    <p>Anda belum pernah mengajukan surat pindah. Yuk, ajukan sekarang!</p>
                                                    <a href="{{ route('user.surat-pindah.create') }}"
...
@push('scripts')
    <!-- Keep the same JavaScript as surat-aktif-kuliah index.blade.php -->
    <script>
