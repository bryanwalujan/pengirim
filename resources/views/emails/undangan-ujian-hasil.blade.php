...
<head>
    ...
    <title>Undangan Ujian Hasil Skripsi</title>
    <style>
        /* Reset & Base Styles */
        body {
        ...
        /* Header - Orange Theme for Ujian Hasil */
        .email-header {
        ...
        /* Judul Box dengan style sedikit berbeda */
        .judul-box {
...
<body>
    <div class="email-container">
        ...
        <div class="email-header">
            <h1>Undangan Ujian Hasil Skripsi</h1>
        ...
        <div class="email-body">
            ...
            <p class="content-text">
                ...
                <strong>Ujian Hasil Skripsi</strong> yang akan diselenggarakan pada:
            </p>
            ...
            <div class="mahasiswa-box">
                ...
                <div class="info-row">
                    ...
                    <span class="info-value">{{ $dosenPembimbing1 }}</span>
                </div>
                @if($dosenPembimbing2)
                <div class="info-row">
                    <span class="info-label">Pembimbing 2</span>
                    <span class="info-value">{{ $dosenPembimbing2 }}</span>
                </div>
                @endif
            </div>
        ...
        <div class="email-footer">
            <p style="font-size: 14px; font-weight: 700; color: #ff9f43; margin: 0 0 10px 0;">
                E-Service UNIMA
            </p>
            <p class="footer-text">
