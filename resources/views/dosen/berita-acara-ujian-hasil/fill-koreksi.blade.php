...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="alert alert-info">
        ...
        Sebagai Dosen Pembimbing ({{ $pengujiInfo->pivot->posisi }}), Anda wajib mengisi detail koreksi/perbaikan skripsi untuk mahasiswa.
    </div>

    <div class="card">
        <h5 class="card-header">Formulir Lembar Koreksi</h5>
        <div class="card-body">
            <form action="{{ route('dosen.berita-acara-ujian-hasil.koreksi.store', $beritaAcara) }}" method="POST" id="formKoreksi">
                @csrf
        ...
        tr.innerHTML = `
            ...
            <td>
                <input type="text" class="form-control" name="koreksi[${rowCount}][halaman]" 
                       placeholder="Contoh: 12, BAB I" value="${halamanVal}" required>
            </td>
            <td>
                <textarea class="form-control" name="koreksi[${rowCount}][catatan]" 
                          rows="2" placeholder="Tuliskan koreksi..." required>${catatanVal}</textarea>
            </td>
