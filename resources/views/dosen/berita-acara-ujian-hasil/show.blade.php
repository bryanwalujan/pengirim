                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <table class="table table-borderless table-sm">
                                    ...
                                    <tr>
                                        <td>Waktu</td>
                                        <td>: {{ $beritaAcara->jadwalUjianHasil->jam_mulai }} -
                                            {{ $beritaAcara->jadwalUjianHasil->jam_selesai }}</td>
                                    </tr>
                                    <tr>
                                        <td>Ruangan</td>
                                    ...
                                    <tr>
                                        <td>Posisi Anda</td>
                                        <td>: <span
                                                class="badge bg-label-info">{{ $pengujiInfo->pivot->posisi ?? 'Penguji' }}</span>
                                        </td>
                                    </tr>
                                </table>
                            </div>
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-6">
                <div class="card h-100 border-start border-4 {{ $myPenilaian ? 'border-success' : 'border-warning' }}">
                    ...
                    <div class="card-body">
                        <p class="card-text">
                            Anda wajib memberikan penilaian terhadap 5 kriteria: Kebaruan, Metode, Data/Software, Referensi,
                        ...
                        @if ($myPenilaian)
                            <div class="alert alert-success d-flex align-items-center">
                                ...
                                <div>
                                    <strong>Total Nilai: {{ $myPenilaian->total_nilai }}
                                        ({{ $myPenilaian->grade_letter }})</strong>
                                </div>
                            </div>
                        @endif
                            ...
                            <div class="d-grid gap-2">
                                @if ($beritaAcara->isMenungguTtdPenguji())
                                    <a href="{{ route('dosen.berita-acara-ujian-hasil.koreksi', $beritaAcara) }}"
                                        ...
                                        {{ $myKoreksi ? 'Edit Lembar Koreksi' : 'Isi Lembar Koreksi' }}
                                    </a>
                                @else
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                @else
                    ...
                    @php
                        // Only penilaian is required, lembar koreksi is optional
                        $canSign = $myPenilaian !== null;
                    @endphp
                    ...
                    @if ($canSign && $beritaAcara->isMenungguTtdPenguji())
                        <div class="text-end">
                            <form action="{{ route('dosen.berita-acara-ujian-hasil.sign-penguji', $beritaAcara) }}"
                                ...
                                <!-- Simplification for now, should prompt or be handled by modal -->
                    ...
                    @elseif(!$canSign)
                        <div class="alert alert-secondary mb-0">
                            ...
                            <strong>Penilaian</strong> terlebih dahulu sebelum menandatangani.
                        </div>
                    @endif
                @endif
            ...
            <div class="modal-content">
                <form action="{{ route('dosen.berita-acara-ujian-hasil.sign-penguji', $beritaAcara) }}" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="alert alert-warning">
                            Anda akan menandatangani Berita Acara Ujian Hasil untuk mahasiswa
                            <strong>{{ $beritaAcara->mahasiswa_name }}</strong>.
