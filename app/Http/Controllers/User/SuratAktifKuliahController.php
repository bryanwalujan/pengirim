...
class SuratAktifKuliahController extends Controller
{
    ...
    public function create()
    {
        ...
        if ($tahunAjaranAktif && Auth::user()->nim) {
            ...
            $semesterNumber = min(max($semesterNumber, 1), 14); // Clamp 1-14
        ...
        return view('user.surat-aktif-kuliah.create', compact('service', 'tahunAjaranAktif', 'kopSurat', 'semesterRoman'));
    }
